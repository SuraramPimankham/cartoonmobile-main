...
//           'sending': {
//             'episodeId': episodeId,
//             'sharedBy': _user!.email, // บันทึกอีเมลของผู้ใช้ที่แชร์
...
//         await FirebaseFirestore.instance.collection('share').add(sendingData);

//         print('แชร์สำเร็จ: $sendingData');
//       } else {
//         print('ผู้ใช้ยังไม่ได้เข้าสู่ระบบ.');
//       }
//     } catch (e) {
...
//   }
  ...
  Future<void> _ShareEp(String userId, String recioient) async {
    try {
      // สร้าง map
