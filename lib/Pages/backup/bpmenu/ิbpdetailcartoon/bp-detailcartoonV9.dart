    ...
    try {
      ...
      if (_user != null) {
        ...
        if (userSnapshot.exists) {
          ...
          // ค้นหา UID ของเพื่อนที่มีอีเมลตรงกับที่ต้องการแชร์
          ...
          if (friendSnapshot.docs.isNotEmpty) {
            ...
            print('Friend Email: $friendName, Friend UID: $friendUid');

            // ตรวจสอบว่ามีข้อมูลการแชร์กับเพื่อนคนนี้หรือไม่
            if (sharedWith.containsKey(friendUid)) {
              // ตรวจสอบว่ามีข้อมูล episode ของเพื่อนหรือยัง
              Map<String, dynamic> friendShareData = sharedWith[friendUid];
            ...
            print('ไม่พบเพื่อนที่มีอีเมล: $friendName');
          }
        }
      }
    } catch (e) {
